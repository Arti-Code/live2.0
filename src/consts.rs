...
pub const ASTER_SIZE_MIN: u32       = 18;
pub const ASTER_SIZE_MAX: u32       = 128;
pub const ASTER_NUM: usize          = 64;
pub const ASTER_SPEED: f32          = 120.0; 
